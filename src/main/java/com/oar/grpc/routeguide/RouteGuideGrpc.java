...
public final class RouteGuideGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.oar.grpc.routeguide.Point,
      com.oar.grpc.routeguide.Feature> getGetFeatureMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetFeature",
      requestType = com.oar.grpc.routeguide.Point.class,
      responseType = com.oar.grpc.routeguide.Feature.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.oar.grpc.routeguide.Point,
      com.oar.grpc.routeguide.Feature> getGetFeatureMethod() {
    io.grpc.MethodDescriptor<com.oar.grpc.routeguide.Point, com.oar.grpc.routeguide.Feature> getGetFeatureMethod;
      ...
      synchronized (RouteGuideGrpc.class) {
        if ((getGetFeatureMethod = RouteGuideGrpc.getGetFeatureMethod) == null) {
          RouteGuideGrpc.getGetFeatureMethod = getGetFeatureMethod =
              io.grpc.MethodDescriptor.<com.oar.grpc.routeguide.Point, com.oar.grpc.routeguide.Feature>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetFeature"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.oar.grpc.routeguide.Point.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.oar.grpc.routeguide.Feature.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.oar.grpc.routeguide.Rectangle,
      com.oar.grpc.routeguide.Feature> getListFeaturesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ListFeatures",
      requestType = com.oar.grpc.routeguide.Rectangle.class,
      responseType = com.oar.grpc.routeguide.Feature.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<com.oar.grpc.routeguide.Rectangle,
      com.oar.grpc.routeguide.Feature> getListFeaturesMethod() {
    io.grpc.MethodDescriptor<com.oar.grpc.routeguide.Rectangle, com.oar.grpc.routeguide.Feature> getListFeaturesMethod;
      ...
      synchronized (RouteGuideGrpc.class) {
        if ((getListFeaturesMethod = RouteGuideGrpc.getListFeaturesMethod) == null) {
          RouteGuideGrpc.getListFeaturesMethod = getListFeaturesMethod =
              io.grpc.MethodDescriptor.<com.oar.grpc.routeguide.Rectangle, com.oar.grpc.routeguide.Feature>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ListFeatures"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.oar.grpc.routeguide.Rectangle.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.oar.grpc.routeguide.Feature.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.oar.grpc.routeguide.Point,
      com.oar.grpc.routeguide.RouteSummary> getRecordRouteMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "RecordRoute",
      requestType = com.oar.grpc.routeguide.Point.class,
      responseType = com.oar.grpc.routeguide.RouteSummary.class,
      methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
  public static io.grpc.MethodDescriptor<com.oar.grpc.routeguide.Point,
      com.oar.grpc.routeguide.RouteSummary> getRecordRouteMethod() {
    io.grpc.MethodDescriptor<com.oar.grpc.routeguide.Point, com.oar.grpc.routeguide.RouteSummary> getRecordRouteMethod;
    if ((getRecordRouteMethod = RouteGuideGrpc.getRecordRouteMethod) == null) {
      synchronized (RouteGuideGrpc.class) {
        if ((getRecordRouteMethod = RouteGuideGrpc.getRecordRouteMethod) == null) {
          RouteGuideGrpc.getRecordRouteMethod = getRecordRouteMethod =
              io.grpc.MethodDescriptor.<com.oar.grpc.routeguide.Point, com.oar.grpc.routeguide.RouteSummary>newBuilder()
              ...
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.oar.grpc.routeguide.Point.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.oar.grpc.routeguide.RouteSummary.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.oar.grpc.routeguide.RouteNote,
      com.oar.grpc.routeguide.RouteNote> getRouteChatMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "RouteChat",
      requestType = com.oar.grpc.routeguide.RouteNote.class,
      responseType = com.oar.grpc.routeguide.RouteNote.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<com.oar.grpc.routeguide.RouteNote,
      com.oar.grpc.routeguide.RouteNote> getRouteChatMethod() {
    io.grpc.MethodDescriptor<com.oar.grpc.routeguide.RouteNote, com.oar.grpc.routeguide.RouteNote> getRouteChatMethod;
    if ((getRouteChatMethod = RouteGuideGrpc.getRouteChatMethod) == null) {
      synchronized (RouteGuideGrpc.class) {
        if ((getRouteChatMethod = RouteGuideGrpc.getRouteChatMethod) == null) {
          RouteGuideGrpc.getRouteChatMethod = getRouteChatMethod =
              io.grpc.MethodDescriptor.<com.oar.grpc.routeguide.RouteNote, com.oar.grpc.routeguide.RouteNote>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "RouteChat"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.oar.grpc.routeguide.RouteNote.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.oar.grpc.routeguide.RouteNote.getDefaultInstance()))
  ...
  public static abstract class RouteGuideImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getFeature(com.oar.grpc.routeguide.Point request,
        io.grpc.stub.StreamObserver<com.oar.grpc.routeguide.Feature> responseObserver) {
     ...
     * </pre>
     */
    public void listFeatures(com.oar.grpc.routeguide.Rectangle request,
        io.grpc.stub.StreamObserver<com.oar.grpc.routeguide.Feature> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<com.oar.grpc.routeguide.Point> recordRoute(
        io.grpc.stub.StreamObserver<com.oar.grpc.routeguide.RouteSummary> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<com.oar.grpc.routeguide.RouteNote> routeChat(
        io.grpc.stub.StreamObserver<com.oar.grpc.routeguide.RouteNote> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.oar.grpc.routeguide.Point,
                com.oar.grpc.routeguide.Feature>(
                  this, METHODID_GET_FEATURE)))
          .addMethod(
            getListFeaturesMethod(),
            asyncServerStreamingCall(
              new MethodHandlers<
                com.oar.grpc.routeguide.Rectangle,
                com.oar.grpc.routeguide.Feature>(
          ...
          .addMethod(
            ...
            asyncClientStreamingCall(
              new MethodHandlers<
                com.oar.grpc.routeguide.Point,
                com.oar.grpc.routeguide.RouteSummary>(
                  this, METHODID_RECORD_ROUTE)))
          .addMethod(
            getRouteChatMethod(),
            asyncBidiStreamingCall(
              new MethodHandlers<
                com.oar.grpc.routeguide.RouteNote,
                com.oar.grpc.routeguide.RouteNote>(
  ...
  public static final class RouteGuideBlockingStub extends io.grpc.stub.AbstractBlockingStub<RouteGuideBlockingStub> {
     ...
     * </pre>
     */
    public com.oar.grpc.routeguide.Feature getFeature(com.oar.grpc.routeguide.Point request) {
     ...
     * </pre>
     */
    public java.util.Iterator<com.oar.grpc.routeguide.Feature> listFeatures(
        com.oar.grpc.routeguide.Rectangle request) {
  ...
  public static final class RouteGuideFutureStub extends io.grpc.stub.AbstractFutureStub<RouteGuideFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.oar.grpc.routeguide.Feature> getFeature(
        com.oar.grpc.routeguide.Point request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_FEATURE:
          serviceImpl.getFeature((com.oar.grpc.routeguide.Point) request,
              (io.grpc.stub.StreamObserver<com.oar.grpc.routeguide.Feature>) responseObserver);
          break;
        case METHODID_LIST_FEATURES:
          serviceImpl.listFeatures((com.oar.grpc.routeguide.Rectangle) request,
              (io.grpc.stub.StreamObserver<com.oar.grpc.routeguide.Feature>) responseObserver);
          break;
        default:
  ...
  private static abstract class RouteGuideBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.oar.grpc.routeguide.RouteGuideProto.getDescriptor();
    }
